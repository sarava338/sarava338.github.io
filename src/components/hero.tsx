...
export default function Hero() {
  return (
    <section className="relative min-h-[90vh] flex items-center justify-center overflow-hidden bg-background">
      ...
      <div className="absolute inset-0 z-0 opacity-40 bg-cover bg-center" style={{ backgroundImage: "url(/assets/hero-bg.png)" }} />
      ...
      <div className="container relative z-10 px-6 mx-auto">
        <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.8 }} className="max-w-3xl">
          ...
          <h1 className="text-5xl md:text-7xl font-heading font-bold leading-tight text-white mb-6">
            Saravanan <br />
            <span className="text-transparent bg-clip-text bg-gradient-to-r from-primary to-emerald-400">Lakshmanan</span>
          </h1>

          <p className="text-xl text-muted-foreground mb-8 max-w-2xl font-light">
            Full Stack Developer specializing in <strong className="text-white font-medium">Java Spring Boot</strong> and{" "}
            <strong className="text-white font-medium">React</strong>. Leveraging 3 years of deep integration expertise to build scalable,
          ...
          <div className="mt-16 grid grid-cols-2 md:grid-cols-3 gap-8 border-t border-white/10 pt-8">
            <div>
              <div className="text-3xl font-mono font-bold text-white mb-1">
                6<span className="text-primary text-lg">mos</span>
              </div>
              <div className="text-sm text-muted-foreground uppercase tracking-wider">Full Stack Dev</div>
            </div>
            <div>
              <div className="text-3xl font-mono font-bold text-white mb-1">
                3<span className="text-secondary-foreground text-lg">yrs</span>
              </div>
